# Generated by Powerlevel10k configuration wizard on 2026-01-20 at 09:04 CET.
...
() {
  ...
  typeset -g POWERLEVEL9K_SHORTEN_STRATEGY=custom
  typeset -g POWERLEVEL9K_DIR_SHORTEN_CUSTOM=last
